...
},{"angular/angular":2}],2:[function(require,module,exports){
/**
 * @license AngularJS v1.3.0-build.3177+sha.d9cdb10
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-build.3177+sha.d9cdb10/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-build.3177+sha.d9cdb10',    // all of these placeholder strings will be replaced by grunt's
